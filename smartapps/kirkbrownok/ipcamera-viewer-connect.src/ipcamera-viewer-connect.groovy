...
definition(
    name: "IPCamera Viewer (Connect)",
    namespace: "kirkbrownOK",
    author: "Kirk Brown",
    description: "Connect and take pictures through IPCamera Viewer App that is connected to your cameras from inside the Smartthings app.",
